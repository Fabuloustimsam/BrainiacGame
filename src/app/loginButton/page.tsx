    ...
    <div className='flex justify-between'>
        <div className='h-[952px] rounded-2xl w-full bg-purple-700'>
            ...
            <footer className='pt-14'>
                ...
                <div className='text-yellow-600 font-bold cursor-pointer'>Create an account</div>
                </div>
        ...
        <form className='w-full flex flex-col h-full px-7 gap-3  bg-white justify-center justify-items-center'>
            <div className='justify-center text-center'>
                <div className='font-black pt-2 pb-16 font-serif text-4xl'>Welcome Back!</div>
            </div>
            ...
            <input className='rounded-2xl relative bg-gray-200 w-[644px] h-[70px] px-4'  type='password' placeholder='Password' />
            <div className='absolute right-12 top-5 items-center'><EyeOff size={24} /> : <Eye size={24} /></div>
            </div>
            ...
            <button className='bg-purple-700 cursor-pointer rounded-2xl text-white w-[644px] h-[70px] my-7 font-black font-serif text-2xl'>Login</button>
